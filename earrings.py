...
earrings_path = "C:/Users/ragha/PycharmProjects/virtual_tryon_website/static/earring_images/earrings_1.png"
...
while True:
    ...
    for face in faces:
        ...
        if landmarks is not None:
            ...
            left_earrings_x = int(left_ear_top[0] - earrings_width / 2)
            left_earrings_y = int(left_ear_top[1] - left_earrings_resized.shape[0] / 2) + 60

            right_earrings_x = int(right_ear_top[0] - earrings_width / 2) + 10
            right_earrings_y = int(
                right_ear_top[1] - right_earrings_resized.shape[0] / 2) - 7# Lower the position by 3 pixels
